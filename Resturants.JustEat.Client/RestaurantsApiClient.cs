...
namespace Restaurants.JustEat.Client
{
    public class RestaurantsApiClient : IRestaurantsApiClient, IDisposable
    {
        ...
        public async Task<RestaurantsRoot> GetRestaurantsByPostCode(string postcode)
        {
            ...
            return JsonConvert.DeserializeObject<RestaurantsRoot>(restaurantsByPostCodeJson);
        }
        ...
        public async Task<RestaurantsRoot> GetRestaurantsByLatLong(string latitude, string longitude)
        {
            ...
            return JsonConvert.DeserializeObject<RestaurantsRoot>(restaurantsByLatLong);
        }
    }
}
